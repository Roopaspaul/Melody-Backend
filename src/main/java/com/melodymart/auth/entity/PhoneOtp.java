...
/**
 * Entity mapping for the 'phone_otp' table.
 * Stores one-time passwords generated for SMS phone number verification or MFA.
 */
@Entity
@Table(name = "phone_otp", indexes = {
    @Index(name = "idx_phone_otp_user", columnList = "user_id"),
    @Index(name = "idx_phone_otp_lookup", columnList = "user_id, otp_code, purpose, is_used")
})
public class PhoneOtp {
    ...
    @JoinColumn(name = "user_id", nullable = false, foreignKey = @ForeignKey(name = "fk_phone_otp_user"))
    private User user;
